...
class RideDetailsWidgets {
        ...
        return Padding(
          ...
          child: Container(
            ...
            child: Center(
                child: Text(
              item.toString(),
              style: AppTextStyle.boldWhite(textSize: normalTextSize),
            )),
          ),
        );
      }),
        ...
        child: Row(
          ...
          children: [
            Container(
              ...
              decoration:
                  BoxDecoration(shape: BoxShape.circle, color: fillInputColor),
              child: const Icon(
                Icons.person,
                size: 40,
              ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style:
                        AppTextStyle.normalBlack(color: semiBoldBlackTextColor),
                  ),
                  5.height,
                  Text(
                    'Driver is on the way... 3min',
                    style: AppTextStyle.semiBoldBlack(
                        textSize: normalTextSize, color: primaryColor),
                  ),
                ],
              ),
            )
  ...
  Widget actionButtonsView() {
    ...
    return Row(
      ...
      children: [
        ButtonWidgets().appButtonFillOutWithIconView(CALL, callIcon,
            width: width * .30, onTap: () async {
          ShareLinkHelper.makePhoneCall(
              INITAL_COUNTRY_CODE, INITAL_MOBILE_NUMBER);
        }),
        ButtonWidgets().appButtonFillOutWithIconView(MESSAGE, messageIcon,
            width: width * .60, onTap: () {
  ...
  Widget pickupView() {
    ...
    return Row(
      ...
      children: [
        ...
        ButtonWidgets().appButtonFillOutView("Trip Details",
            width: width * .40, height: 45, onTap: () {
          AppDialogHelper.showCustomBottomSheet(context,
              child: const RideDetailsScreen(), height: height / 2.3);
        })
      ],
    );
  }
      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              Text(
                "Share your trip with your family",
                style: AppTextStyle.normalBlack(),
              ),
              Text(
                "Share with 2 person",
          ...
          InkWell(
            ...
            child: Column(
              children: [
                ...
                AppImageView()
                    .assetSVGImageView(destinationIcon, color: Colors.red)
              ],
            ),
          )
        ],
